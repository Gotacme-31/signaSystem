...
import { User, ChevronDown, ChevronUp, Clock, Paperclip, Upload, Download, Trash2, Loader2, Clipboard } from "lucide-react";
...
export default function ActiveOrders() {
  ...
  return isAdmin ? <AdminShell>{page}</AdminShell> : page;
}
